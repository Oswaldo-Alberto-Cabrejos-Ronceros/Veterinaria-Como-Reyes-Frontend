...
onMounted(() => {
  firstName.value = props.client.firstName
  secondName.value = props.client.secondName
  lastName.value = props.client.lastName
  secondLastName.value = props.client.secondLastName
  dni.value = props.client.dni

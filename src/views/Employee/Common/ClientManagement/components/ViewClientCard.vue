...
<template>
  <Card class="h-auto w-[80vw] md:w-auto bg-transparent shadow-none">
    <template #title>
    ...
    <template v-if="clientData" #content>
      <div class="flex-1 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 text-neutral-950 dark:text-surface-0">
